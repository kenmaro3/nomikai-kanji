...
import { extract_http_url } from "../../lib/util"
                              ...
                              return (
                                <li className="w-full rounded-t-lg border-b border-gray-200 ">
                                  <div className="flex items-center pl-3">
                                    ...
                                    <a href={extract_http_url(planToShow.venue[location][venueIndex])} for="list-radio-license" target="_blank" rel="noopener noreferrer" className="overflow-hidden py-3 ml-2 w-full text-sm font-medium text-gray-900 ">{planToShow.venue[location][venueIndex]}</a>
                                  </div>
                                </li>
                              )
